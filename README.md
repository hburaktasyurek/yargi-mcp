...
`search_bedesten_semantic` opsiyonel `karar_yil_start` / `karar_yil_end` parametrelerini kabul eder. Bu yıl aralığı Bedesten'e `kararTarihiStart` / `kararTarihiEnd` olarak gönderilir.
